...
var _ datasource.DataSource = &RedirectionHostDataSource{}

func NewRedirectionHostDataSource() datasource.DataSource {
	return &RedirectionHostDataSource{}
}
...
func (d *RedirectionHostDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_redirection_host"
}

func (d *RedirectionHostDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Hosts --- This data source can be used to get information about a specific redirection host.",
...
func (d *RedirectionHostDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	response, _, err := d.client.RedirectionHostsAPI.GetRedirectionHost(d.auth, data.Id.ValueInt64()).Execute()
	if err != nil {
